...
class _CreatePondSheetState extends State<CreatePondSheet> {
  ...
  bool get _isFormValid =>
      _newPondNameController.text.trim().isNotEmpty &&
  ...
  void initState() {
    super.initState();
    // Rebuild to re-evaluate _isFormValid
    _newPondNameController.addListener(() => setState(() {}));
  ...
  Widget _buildHeader(BuildContext context, ThemeData theme, bool isDark) {
    IconData headerIcon = Icons.water_drop_rounded;
