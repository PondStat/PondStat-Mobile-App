...
import 'package:pondstat/features/monitoring/presentation/widgets/edit_parameter_group_card.dart';
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: widget.docs.map((doc) {
                    ...
                    return EditParameterGroupCard(
                      doc: doc,
                      controllers: groupControllers[doc.id]!,
                      notesController: notesControllers[doc.id]!,
