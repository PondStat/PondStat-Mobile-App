...
class CreatePondSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CreatePondSheet> createState() => _CreatePondSheetState();
}

class _CreatePondSheetState extends ConsumerState<CreatePondSheet> {
  ...
  Future<void> _createNewPond() async {
    ...
    try {
      final pond = Pond(
        id: '', // Generated by Firestore later
        name: pondName,
        species: species,
